...
export abstract class  GraphIterator implements IIterator {
...
export class WidthIterator extends GraphIterator {
...
export class DepthIterator extends GraphIterator {
